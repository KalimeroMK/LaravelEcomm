...
beforeEach(function () {
    ...
    if ($driver === 'sqlite') {
        $this->markTestSkipped('Tenant command tests require MySQL or file-based SQLite (SQLite in-memory triggers VACUUM-in-transaction errors).');
    }
    ...
    // when multiple tests run (shared :memory: would conflict)
