            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="chart-pie pt-4 pb-2">
                        <div class="chart-container"><canvas id="ordersPieChart"></canvas></div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="tab-pane fade" id="users" role="tabpanel">
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="chart-container"><canvas id="userRegistrationsChart"></canvas></div>
                                </div>
                                <div class="col-md-6">
                                    <h5>User Segments</h5>
                                    <div class="chart-container"><canvas id="userSegmentsChart"></canvas></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="performance" role="tabpanel">
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="chart-container"><canvas id="trafficSourcesChart"></canvas></div>
                                </div>
                            </div>
                        </div>
                    </div>
