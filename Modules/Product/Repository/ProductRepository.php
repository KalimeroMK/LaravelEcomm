<?php
    ...
    class ProductRepository
    {
        ...
        /**
         * @return _IH_Product_C|\Illuminate\Contracts\Pagination\LengthAwarePaginator|LengthAwarePaginator|array
         */
        public function getAll(): _IH_Product_C|\Illuminate\Contracts\Pagination\LengthAwarePaginator|LengthAwarePaginator|array
        {
            return Product::with(['brand', 'categories'])->orderBy('id', 'desc')->paginate(10);
        }
