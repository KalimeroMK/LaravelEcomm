                ...
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        <a href="{{route('front.index')}}"><img
                                    src="{{ $settings->first()?->getFirstMediaUrl('settings') ?: asset(ltrim($settings->first()?->logo ?? 'frontend/img/logo.png', '/')) }}"
                                    alt="logo"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                ...
                <div class="row">
                    @if (Request::path() == '/')
                                        ...
                                        @if($category->childrenCategories->isNotEmpty())
                                            <ul class="sub-category">
                                                @foreach ($category->childrenCategories as $childCategory)
                                                    @include('front::themes.modern.layouts.child_category', ['child_category' => $childCategory])
                                                @endforeach
                                            </ul>
                                        @endif
                                    </li>
                        ...
                        <div class="col-lg-9 col-12">
                            <div class="menu-area">
                                <!-- Main Menu -->
                                @include('front::themes.modern.layouts.menu')
                                <!--/ End Main Menu -->
                            </div>
                        </div>
                    @else
