...
class LoginSecurityController extends Controller
{
     ...
     */
    public function show2faForm(): Factory|View|Application
    {
        $user          = Auth::user();
        $google2fa_url = "";
        $secret_key    = "";
     ...
     */
    public function generate2faSecret(): Redirector|RedirectResponse|Application
    {
        $user = Auth::user();
     ...
     * @return Application|RedirectResponse|Redirector
     */
    public function verify2fa(): Redirector|RedirectResponse|Application
    {
