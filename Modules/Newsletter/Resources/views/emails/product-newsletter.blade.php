                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <p>{!! str_limit(strip_tags($product->description), 300, '...')!!}</p>
                                </td>
                            </tr>
                        </table>
                    @endif
                    ...
                    <div class="content">
                        ...
                        <table bgcolor="">
                            <tr>
                                ...
                                <td>
                                    <h4>{{ $product->title }}</h4>
                                    <p class="">{!! str_limit(strip_tags($product->description), 200, '...')!!}</p>
                                    <a href="https://ogledalo.mk/{{ $product->slug }}" class="btn">Clickity Click
                                        &raquo;</a>
                                </td>
                            </tr>
                        </table>
