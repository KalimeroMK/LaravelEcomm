...
return [
    ...
    */
    ...
    'loggerMiddlewareExcept' => array_filter(explode(',', mb_trim((string) env('LARAVEL_LOGGER_MIDDLEWARE_EXCEPT') ?? ''))),
    ...
    */
    ...
    'defaultActivityModel' => env('LARAVEL_LOGGER_ACTIVITY_MODEL', 'Modules\Core\Models\Activity'),
